...
func TestNonePolicyGetAssignableCPUs(t *testing.T) {
	...
	cpus := policy.GetAssignableCPUs(st)
	if cpus.Size() != 0 {
		t.Errorf("NonePolicy GetAssignableCPUs() error. expected empty set, returned: %v", cpus)
	}
}
